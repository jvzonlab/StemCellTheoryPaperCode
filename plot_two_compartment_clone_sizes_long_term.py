...
def _plot_clone_sizes_over_time(ax: Axes, results: TimedCloneSizeDistribution, *, legend: bool = True):
    ...
    ax.plot(durations, results.get_clone_size_frequency_over_time([4, 6, 8]), label="4,6,8", color="#00b894")
...
t_clone_size = 300
t_interval = 1
config = TimedCloneSizeSimulationConfig(t_clone_size=t_clone_size, t_interval=t_interval, random=random, n_crypts=50)
